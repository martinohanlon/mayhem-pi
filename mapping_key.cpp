...
char* key_to_str(int key) {
  switch(key) {
    ...
    case ALLEGRO_KEY_PAD_1 : return("Keypad 1");
    case ALLEGRO_KEY_PAD_2 : return("Keypad 2");
    case ALLEGRO_KEY_PAD_3 : return("Keypad 3");
    case ALLEGRO_KEY_PAD_4 : return("Keypad 4");
    case ALLEGRO_KEY_PAD_5 : return("Keypad 5");
    case ALLEGRO_KEY_PAD_6 : return("Keypad 6");
    case ALLEGRO_KEY_PAD_7 : return("Keypad 7");
    case ALLEGRO_KEY_PAD_8 : return("Keypad 8");
    case ALLEGRO_KEY_PAD_9 : return("Keypad 9");
    ...
    case ALLEGRO_KEY_LSHIFT       : return("LShift");
    case ALLEGRO_KEY_RSHIFT       : return("RShift");
    case ALLEGRO_KEY_LCTRL        : return("LCtrl");
    case ALLEGRO_KEY_RCTRL        : return("RCtrl");
    case ALLEGRO_KEY_ALT          : return("Alt");
    case ALLEGRO_KEY_ALTGR        : return("AltGr");
    case ALLEGRO_KEY_LWIN         : return("LWin");
    case ALLEGRO_KEY_RWIN         : return("RWin");
    case ALLEGRO_KEY_MENU         : return("Menu");
    case ALLEGRO_KEY_SCROLLLOCK   : return("Scrollock");
    case ALLEGRO_KEY_NUMLOCK      : return("Numlock");
    case ALLEGRO_KEY_CAPSLOCK     : return("Capslock");
    ...
    case ALLEGRO_KEY_BACKSLASH2   : return("\\");
    ...
    case ALLEGRO_KEY_PGUP         : return("PgUp");
    case ALLEGRO_KEY_PGDN         : return("PgDn");
    ...
    case ALLEGRO_KEY_PAD_SLASH    : return("Keypad /");
    case ALLEGRO_KEY_PAD_ASTERISK : return("Keypad *");
    case ALLEGRO_KEY_PAD_MINUS    : return("Keypad -");
    case ALLEGRO_KEY_PAD_PLUS     : return("Keypad +");
