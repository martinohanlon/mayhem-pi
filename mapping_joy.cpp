...
JoyButton mapping_joy::btn_sets[4][5] = {
  {JoyButton::LEFT_STICK_X_LEFT, JoyButton::LEFT_STICK_X_RIGHT, JoyButton::BUTTON_A, JoyButton::BUTTON_B, JoyButton::BUTTON_RIGHT_SHOULDER},
  {JoyButton::LEFT_STICK_X_LEFT, JoyButton::LEFT_STICK_X_RIGHT, JoyButton::BUTTON_A, JoyButton::BUTTON_B, JoyButton::BUTTON_RIGHT_SHOULDER},
  {JoyButton::LEFT_STICK_X_LEFT, JoyButton::LEFT_STICK_X_RIGHT, JoyButton::BUTTON_A, JoyButton::BUTTON_B, JoyButton::BUTTON_RIGHT_SHOULDER},
  {JoyButton::LEFT_STICK_X_LEFT, JoyButton::LEFT_STICK_X_RIGHT, JoyButton::BUTTON_A, JoyButton::BUTTON_B, JoyButton::BUTTON_RIGHT_SHOULDER}};
...
char* button_to_str(JoyButton button) {
  switch(button) {
  case JoyButton::LEFT_STICK_X_LEFT    : return("Left Stick Left");
  case JoyButton::LEFT_STICK_X_RIGHT   : return("Left Stick Right");
  case JoyButton::LEFT_STICK_Y_UP      : return("Left Stick Up");
  case JoyButton::LEFT_STICK_Y_DOWN    : return("Left Stick Down");
  case JoyButton::LEFT_TRIGGER         : return("Left Trigger");
  case JoyButton::RIGHT_STICK_X_LEFT   : return("Right Stick Left");
  case JoyButton::RIGHT_STICK_X_RIGHT  : return("Right Stick Right");
  case JoyButton::RIGHT_STICK_Y_UP     : return("Right Stick Up");
  case JoyButton::RIGHT_STICK_Y_DOWN   : return("Right Stick Down");
  case JoyButton::RIGHT_TRIGGER        : return("Right Trigger");
  case JoyButton::DPAD_X_LEFT          : return("Dpad Left");
  case JoyButton::DPAD_X_RIGHT         : return("Dpad Right");
  case JoyButton::DPAD_Y_UP            : return("Dpad Up");
  case JoyButton::DPAD_Y_DOWN          : return("Dpad Down");
  case JoyButton::BUTTON_A             : return("A");
  case JoyButton::BUTTON_B             : return("B");
  case JoyButton::BUTTON_X             : return("X");
  case JoyButton::BUTTON_Y             : return("Y");
  case JoyButton::BUTTON_LEFT_STICK    : return("Left Stick Button");
  case JoyButton::BUTTON_RIGHT_STICK   : return("Right Stick Button");
  case JoyButton::BUTTON_LEFT_SHOULDER : return("Left Shoulder");
  case JoyButton::BUTTON_RIGHT_SHOULDER: return("Right Shoulder");
  case JoyButton::BUTTON_START         : return("Start");
  case JoyButton::BUTTON_BACK          : return("Back");
  case JoyButton::BUTTON_XBOX          : return("Xbox");
  default:
    return "?";
  }
}
