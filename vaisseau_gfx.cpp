...
void cleanup_vaisseau_gfx(struct vaisseau_gfx* vaisseau)
  {
    if (vaisseau->sprite) al_destroy_bitmap(vaisseau->sprite);
    if (vaisseau->sprite_shield) al_destroy_bitmap(vaisseau->sprite_shield);
    if (vaisseau->sprite_thrust) al_destroy_bitmap(vaisseau->sprite_thrust);
  if (vaisseau->sprite_thrust2) al_destroy_bitmap(vaisseau->sprite_thrust2);
  }
